"""Long-term (1960-1999) batch processor with configurable options."""
...
DEFAULT_INPUT_DIR = Path(r"Z:/Runoff_Flood/China_runoff/daily_Q_60_99")
DEFAULT_OUTPUT_DIR = Path(r"Z:/LCM/Baseflow_seperation/daily60_99_outputs")
DEFAULT_INFO_FILE = Path(r"Z:/Runoff_Flood/China_runoff/info2.xlsx")


def _parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Process 1960-1999 station records.")
...
def run_batch(config: BatchConfig) -> None:
    ...
    for idx, filepath in enumerate(tqdm(files, desc="📦 处理60-99站点", unit="站点")):
